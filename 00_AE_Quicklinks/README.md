# Quicklinks - Agent Engineering

Quicklinks are to help you **easily navigate individual lesson information** for `Agent Engineering`!

### Pre-Course Setup

| 📰 Module |
|:-----------------|
|[🧑‍💻 Git Setup](../00_Docs/Modules/00_Git_Setup.md) 

### Week 1: Building & Vibe Checking Classic RAG Applications
...
| 📰 Module | ⏺️ Recording  | 🖼️ Slides     | 👨‍💻 Repo     | 📝 Homework      | 📁 Feedback       |
|:-----------------|:-----------------|:-----------------|:-----------------|:-----------------|:-----------------|
|[🔁 The Agent Loop](../00_Docs/Modules/03_The_Agent_Loop.md) | TBD | [Week 2 Slides](https://www.canva.com/design/DAHATfSSoiE/VxdmkItAu8acETozDzFq8Q/edit?utm_content=DAHATfSSoiE&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton) | [`03_The_Agent_Loop`](../03_The_Agent_Loop) | [Module 3 Assignment: Agentic Loop](https://forms.gle/LxnBbjnGTcbe8Xug6) | [Week 2 Feedback](https://forms.gle/wPQKAwXHaqo2V5aW6) |
|[🕴️ Agentic RAG From Scratch](../00_Docs/04_Agentic-RAG-from-Scratch) | TBD | - | [`4_Agentic_RAG_From _Scratch`](../04_Agentic_RAG_From_Scratch) | [Module 5 Assignment: Agentic RAG](https://forms.gle/UP6gyW8Ge2Y8ycUn7) | - |
